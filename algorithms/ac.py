...
class AC:
    ...
    def initNetworks(self):
        ...
        self.qValueModel = self.createRegularizedModel(self.size_observation, self.size_action, self.hiddenLayersQValue, "relu", "linear", "mse", self.learningRateQValue, self.bias)
